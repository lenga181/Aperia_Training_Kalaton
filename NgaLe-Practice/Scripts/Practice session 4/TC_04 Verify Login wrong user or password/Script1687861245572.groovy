...
//Input username and password	"value: Admin / password: admin1234"
...
//Input username and password	"value: Admin1
//password: admin123"	Should input successful
WebUI.setText(findTestObject('Page_Login/txt_userName'), 'Admin1')
WebUI.setText(findTestObject('Page_Login/txt_passWord'), 'admin123')

//Should input successful
WebUI.verifyElementAttributeValue(findTestObject('Page_login/txt_UserName'), 'value','Admin1',1)
WebUI.verifyElementAttributeValue(findTestObject('Page_login/txt_passWord'), 'value','admin1234',1)
